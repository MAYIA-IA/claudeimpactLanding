...
const TEAM: TeamMember[] = [
  ...
  },
  {
    ...
    initials: 'CI',
    color: '#F2C0A7',
    bio: 'Especialista en integración de LLMs con fuentes de datos externas. Responsable del diseño de herramientas MCP (tools) y de la pipeline de actualización automática de datasets desde el portal de datos abiertos.',
  ...
  },
  {
    ...
    initials: 'ST',
    color: '#DA7756',
    bio: 'Desarrollador enfocada en aplicaciones de IA para ciudades inteligentes. Diseña la interfaz y documentación del servidor, además de los casos de uso para gobierno, academia y periodismo de datos.',
    tags: ['Smart Cities', 'UX', 'Docs'],
    icon: '◇',
  },
]
